...
let findnum: number [] = [5];
let result = numbers!=findnum; //whether an item is in a array
if (result) {console.log('statement is true')} else {console.log('statement is false')}; 


let fruits:string [] = ["Mango", "Peach", "Strawberry", "Plum", "Melon"];
let findfruits:string [] = ["Kiwi"];
let result1 = fruits==findfruits; //whether an item is not in a array
if (result1) {console.log('statement is true')} else {console.log('statement is false')}; 
